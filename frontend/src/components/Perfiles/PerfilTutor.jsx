...
const PerfilTutor = () => {
  ...
  const handleCancelarSuscripcion = async () => {
    ...
    const confirmar = window.confirm(
      `¿Estás seguro que deseas cancelar tu suscripción al plan "${suscripcion.id_plan.nombre}"? ` +
      `Esta acción no se puede deshacer y perderás acceso a los beneficios del plan.`
    );
    ...
    try {
      ...
      if (data?.success) {
        ...
        showNotification({
          ...
          message: data?.message || 'No se pudo cancelar la suscripción.',
          duration: 5000
        });
      }
    } catch (error) {
              ...
              {suscripcion && suscripcion.id_plan ? (
                <div className="subscription-card">
                  <div className="subscription-card-header">
                    ...
                    <span className="subscription-status">Activo</span>
                  </div>
                ...
                <div className="subscription-card subscription-card-empty">
                  ...
                  <p className="subscription-empty-text">
                    Aún no tienes un plan contratado. Explora nuestros planes
                    para comenzar a publicar y gestionar tus cursos.
                  </p>
