<template>
  <div class="edit-perfil-tutor-page">
    <!-- Header -->
    <div class="header">
      <div class="container">
            ...
            <div class="form-section">
              ...
              <div class="form-group">
                ...
                <div class="specialties-container">
                  <div 
                    v-for="(specialty, index) in form.especialidades" 
                    :key="index"
                  ...
                  >
                    <input
                      type="text"
                      class="form-input"
                      v-model="form.especialidades[index]"
                  ...
                  <button type="button" @click="addSpecialty" class="add-specialty-btn">
...
export default {
  ...
  setup() {
    ...
    const fetchUserProfile = async () => {
      try {
        ...
        if (response.data.success) {
          ...
          form.value.biografia = user.biografia || ''
          form.value.ci = user.ci || ''
        }
      } catch (error) {
    ...
    const removeSpecialty = (index) => {
      if (form.value.especialidades.length > 1) {
    ...
    const handleSave = async () => {
      ...
      const validSpecialties = form.value.especialidades.filter(s => s.trim() !== '')
      ...
      try {
        ...
        // Aquí iría la lógica para actualizar el perfil del tutor
        ...
        userData.biografia = form.value.biografia
        userData.ci = form.value.ci
        userData.especialidades = validSpecialties
